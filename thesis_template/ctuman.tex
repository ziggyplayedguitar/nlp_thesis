...
\subsection{Limitations of Stylometry}
Though stylometry has proven useful for text classification, recent advancements in large language models and their potential for misuse might pose a challenge to its efficacy in troll detection. As demonstrated by Schuster et al.\cite{Schuster2020}, stylmoetry may struggle to differentiate between human-written and machine-generated text. It may also struggle to correctly classify machine-generated troll text  especially when dealing with sophisticated language models that can mask subtle stylistic variations that would typically be present in human-generated troll content.
